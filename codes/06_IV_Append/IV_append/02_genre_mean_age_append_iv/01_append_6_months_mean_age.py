...
games_features_path = 'C:/Users/charles/PycharmProjects/Quick_Generate_DataSet/data/sourse_game_features_dataset/games-features(age_month6).csv'

out_put_path = 'C:/Users/charles/PycharmProjects/Quick_Generate_DataSet/codes/06_IV_Append/IV_append/02_genre_mean_age_append_iv/'
...
id_genre_statis_df.to_csv(out_put_path + 'genre_statis_mean_age(6 months 201906-201911).csv')
id_age_statis_df.to_csv(out_put_path + 'age_statis_mean_age(6 months 201906-201911 ).csv')
average_age_df.to_csv(out_put_path + 'average_age(6 months 201906-201911).csv')
