...
average_age_list = ['ave_age_Action', 'ave_age_Adventure', 'ave_age_Early+Access', 'ave_age_Ex+Early+Access', 'ave_age_Free', 'ave_age_Indie', 'ave_age_Massively', 'ave_age_RPG',
...
id_genre_statis_df.to_csv('/Users/charles/PycharmProjects/Games_Research/IV_append/genre_mean_age_append_iv/' + 'genre_statis_mean_age(6 quarters).csv')
id_age_statis_df.to_csv('/Users/charles/PycharmProjects/Games_Research/IV_append/genre_mean_age_append_iv/' + 'age_statis_mean_age(6 quarters).csv')
average_age_df.to_csv('/Users/charles/PycharmProjects/Games_Research/IV_append/genre_mean_age_append_iv/' + 'average_age(6 quarters).csv')
