...
six_months_static_file_path = 'C:/Users/charles/PycharmProjects/Quick_Generate_DataSet/codes/06_IV_Append/IV_append/01_b_genre_statistic/genre_statis(6 months).csv'
...
genre_IV_df.rename(
    columns={'Action': 'IV_count_Action', 'Adventure': 'IV_count_Adventure', 'Early+Access': 'IV_count_Early+Access',
             'Ex+Early+Access': 'IV_count_Ex+Early+Access', 'Free': 'IV_count_Free', 'Indie': 'IV_count_Indie',
             'Massively': 'IV_count_Massively', 'RPG': 'IV_count_RPG', 'Simulation': 'IV_count_Simulation',
             'Sports': 'IV_count_Sports', 'Strategy': 'IV_count_Strategy', 'Others': 'IV_count_Others'}, inplace=True)
print(genre_IV_df.info())

genre_IV_df.to_csv(
    'C:/Users/charles/PycharmProjects/Quick_Generate_DataSet/codes/06_IV_Append/IV_append/04_genre_append_iv/IV_count_6_months(201906-201911).csv')
